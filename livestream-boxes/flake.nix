{
  ...
  outputs = { self, nixpkgs, ajantv2 }:
    ...
    in {
      nixosConfigurations = {
        livestream-blue = mkStreambox {
          hostname = "livestream-blue";
          ip_addr = "172.31.152.107";
        };
        livestream-yellow = mkStreambox {
          hostname = "livestream-yellow";
          ip_addr = "172.31.152.117";
        };
        livestream-green = mkStreambox {
          hostname = "livestream-green";
          ip_addr = "172.31.152.127";
        };
      };
    };
}
